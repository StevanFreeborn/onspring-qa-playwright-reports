import {
  ...
  b as Oe,
  d as je,
} from './assets/wsPort-0625ac95.js';
class he {
  constructor() {
...
class Ae {
  ...
  _onConfigure(e) {
    var t;
    (this._rootDir =
      ((t = this._reportConfig) == null ? void 0 : t.rootDir) || e.rootDir),
  ...
  _onProject(e) {
    ...
    t ||
      ((t = new O(e.name, 'project')),
      this._rootSuite.suites.push(t),
      (t.parent = this._rootSuite));
    const s = this._parseProject(e);
    if (
      ((t.project = () => s),
      this._mergeSuitesInto(e.suites, t),
      this._listOnly)
    ) {
      const i = new Set(),
        r = a => {
          a.tests.map(c => c.testId).forEach(c => i.add(c)),
            a.suites.forEach(r);
        };
      e.suites.forEach(r);
      const o = a => {
  ...
  _onStepEnd(e, t, s) {
    ...
    (o.duration = s.duration),
      (o.error = s.error),
      (c = (a = this._reporter).onStepEnd) == null || c.call(a, i, r, o);
  }
  _onError(e) {
    var t, s;
  ...
  _onStdIO(e, t, s, i, r) {
    ...
    e === 'stdout'
      ? (c == null || c.stdout.push(o),
        (u = (g = this._reporter).onStdOut) == null || u.call(g, o, a, c))
      : (c == null || c.stderr.push(o),
        (p = (_ = this._reporter).onStdErr) == null || p.call(_, o, a, c));
  }
  async _onEnd(e) {
    var t, s;
  ...
  _onExit() {
    ...
    return (
      (this._stringPool = new he()),
      (t = (e = this._reporter).onExit) == null ? void 0 : t.call(e)
    );
  }
  _parseConfig(e) {
    const t = { ...me, ...e };
    return (
      this._reportConfig &&
        ...
        (t.reporter = [...this._reportConfig.reporter])),
      t
    );
  }
  _parseProject(e) {
  ...
  _mergeTestsInto(e, t) {
    for (const s of e) {
      let i = this._reuseTestCases
        ? t.tests.find(r => r.title === s.title)
        : void 0;
      i ||
  ...
  _absolutePath(e) {
    return (
      e &&
      this._stringPool.internString(this._rootDir + this._pathSeparator + e)
    );
  }
}
class O {
        ...
        return (
          (async () => {
            ...
            const d = new g({
              ...
              m = new u();
            d.loadAddon(m);
            for (const b of n.pending) d.write(b);
            (n.write = b => {
              n.pending.push(b), d.write(b);
            }),
              (n.clear = () => {
                (n.pending = []), d.clear();
              }),
...
const j = {
    ...
    resize: (n, e) => {
      (_e = { cols: n, rows: e }), H('resizeTerminal', { cols: n, rows: e });
    },
  },
  Xe = ({}) => {
    var ue;
    ...
    f.useEffect(() => {
      ...
      (le = f.useCallback(
        (C, B, W, z) => {
          const I = C.configFile
            ? ge.getObject(C.configFile + ':projects', void 0)
            : void 0;
          for (const D of o.keys())
            B.suites.find(J => J.title === D) || o.delete(D);
          for (const D of B.suites)
            o.has(D.title) ||
              o.set(D.title, !!(I != null && I.includes(D.title)));
          !I &&
            o.size &&
            ![...o.values()].includes(!0) &&
            o.set(o.entries().next().value[0], !0),
            g({ config: C, rootSuite: B, loadErrors: W }),
            a(new Map(o)),
            M && z ? _({ ...z, total: M.testIds.size }) : z || _(void 0);
        },
        [o, M]
      ));
    const ie = f.useCallback(
        (C, B) => {
          (C === 'bounce-if-busy' && M) ||
            ...
            (l.current = l.current.then(async () => {
              var I, D, J;
              const W = k.current;
              if (((k.current = new Set()), !W.size)) return;
              {
                for (const L of ((I = c.rootSuite) == null
                  ? void 0
                  : I.allTests()) || [])
                  W.has(L.id) &&
                    (L._clearResults(), L._createTestResult('pending'));
                g({ ...c });
              }
              const z = '  [' + new Date().toLocaleTimeString() + ']';
              j.write(
                '\x1B[2m—'.repeat(Math.max(0, _e.cols - z.length)) +
                  z +
                  '\x1B[22m'
              ),
                _({ total: W.size, passed: 0, failed: 0, skipped: 0 }),
                P({ testIds: W }),
                await F('run', {
                  testIds: [...W],
                  projects: [...o].filter(([L, Ee]) => Ee).map(([L]) => L),
                });
              for (const L of ((D = c.rootSuite) == null
                ? void 0
                : D.allTests()) || [])
                ((J = L.results[0]) == null ? void 0 : J.duration) === -1 &&
                  L._clearResults();
              g({ ...c }), P(void 0);
            })));
        },
      ...
      ke = f.useCallback(C => {
        ...
        C.preventDefault(),
          C.stopPropagation(),
          (B = ne.current) == null || B.showModal();
      }, []),
      oe = f.useCallback(C => {
        var B;
        C.preventDefault(),
          C.stopPropagation(),
          (B = ne.current) == null || B.close();
      }, []),
      Te = f.useCallback(
        C => {
          oe(C),
            ...
            v('div', {
              ...
              children: [
                ...
                h('div', {
                  ...
                  children: h(Ge, {
                    item: p,
                    rootDir: (ue = c.config) == null ? void 0 : ue.rootDir,
                  }),
                }),
              ],
            }),
...
Projects: ` +
  ...
  Ze = ({
    ...
    const [d, m] = f.useState({ expandedItems: new Map() }),
      ...
      [y, M] = f.useState(p),
      {
        ...
        return E(l), _(w), { rootItem: l, treeItemMap: k, fileNames: S };
      }, [t, s, n, e, _, r]);
    f.useEffect(() => {
      if (y !== p) {
        ...
        w.children.forEach(k),
          !l &&
            ...
            ((w.kind === 'test' && r.testIds.has(w.test.id)) ||
              (w.kind === 'case' &&
                r.testIds.has((S = w.tests[0]) == null ? void 0 : S.id))) &&
            (l = w);
      };
      k(P), l && T(l.id);
    }, [r, T, P, y, M, p, d, m, R]);
          ...
          source: {
            errors: s.loadErrors
              .filter(S => {
                var E;
                return (
                  ((E = S.location) == null ? void 0 : E.file) ===
                  l.location.file
                );
              })
  ...
  Ge = ({ item: n, rootDir: e }) => {
    const [t, s] = f.useState(),
      [i, r] = f.useState(0),
      o = f.useRef(null),
      { outputDir: a } = f.useMemo(
        () => ({ outputDir: n.testCase ? tt(n.testCase) : void 0 }),
        [n]
      ),
      [c, g] = f.useState(),
      ...
      _ = c
        ? t == null
          ? void 0
          : t.model.actions.find(p => de(p) === c)
        : void 0;
    return (
      f.useEffect(() => {
        var b, T;
        o.current && clearTimeout(o.current);
        const p = (b = n.testCase) == null ? void 0 : b.results[0];
        if (!p) {
          s(void 0);
          return;
        }
        const d =
          p && p.duration >= 0 && p.attachments.find(y => y.name === 'trace');
        if (d && d.path) {
        ...
        const m = `${a}/${Ye(p.workerIndex)}/traces/${
          (T = n.testCase) == null ? void 0 : T.id
        }.json`;
        return (
...
const fe = () => {
    clearTimeout(G),
      (G = void 0),
      le($.config, $.rootSuite, $.loadErrors, $.progress);
  },
  U = (n, e, t, s, i = !1) => {
    ($ = { config: n, rootSuite: e, loadErrors: t, progress: s }),
      i ? fe() : G || (G = setTimeout(fe, 250));
  },
  be = n => {
    if (!n) return F('list', {});
    let e;
...
`
  ...
  et = (n, e) => {
    ...
    (t = q == null ? void 0 : q.dispatch({ method: n, params: e })) == null ||
      t.catch(() => {});
  },
  tt = n => {
    var e;
  ...
  const s = [...t.values()].some(Boolean),
    ...
    r = (a, c, g) => {
      for (const u of c.suites) {
        const _ = u.title || '<anonymous>';
        let p = g.children.find(d => d.title === _);
        p ||
          ((p = {
            kind: 'group',
            subKind: 'describe',
      ...
      for (const u of c.tests) {
        const _ = u.title;
        let p = g.children.find(b => b.title === _);
        p ||
          ((p = {
            kind: 'case',
            id: g.id + '' + _,
        ...
        (d == null ? void 0 : d.statusEx) === 'scheduled'
          ...
          (p.duration = p.children.reduce((b, T) => b + T.duration, 0));
      }
    },
    o = new Map();
...
function nt(n, e, t, s) {
  const i = e.trim().toLowerCase().split(' '),
    ...
    o = c => {
      ...
      return !i.every(u => g.includes(u)) &&
        !c.tests.some(u => (s == null ? void 0 : s.has(u.id)))
        ? !1
    ...
    a = c => {
      ...
      for (const u of c.children)
        u.kind === 'case'
          ? o(u) && g.push(u)
          : (a(u), (u.children.length || u.hasLoadErrors) && g.push(u));
      c.children = g;
    };
  a(n);
}
function ve(n) {
  ...
  n.kind === 'group' &&
    n.children.sort(
      (o, a) =>
        o.location.file.localeCompare(a.location.file) ||
        o.location.line - a.location.line
    );
