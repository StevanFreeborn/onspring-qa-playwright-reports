import { n as vu, o as gu } from './wsPort-0625ac95.js';
var pa = { exports: {} };
(function (mr, Or) {
  (function (I, Pe) {
    mr.exports = Pe();
    ...
    var I = navigator.userAgent,
      ...
      J = /Android/.test(I),
      te =
        re || J || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(I),
      xe = re || /Mac/.test(Pe),
      Be = /\bCrOS\b/.test(I),
      ye = /win/i.test(Pe),
    ...
    var fe = function () {
      (this.id = null),
        (this.f = null),
        (this.time = 0),
        (this.handler = We(this.onTimeout, this));
    };
    ...
    function T(e) {
      return (
        /\w/.test(e) ||
        (e > '' && (e.toUpperCase() != e.toLowerCase() || A.test(e)))
      );
    }
    function pe(e, t) {
    ...
    var vi = (function () {
      ...
      return function (u, d) {
        ...
        for (var b = u.length, m = [], C = 0; C < b; ++C)
          m.push(n(u.charCodeAt(C)));
        ...
        return (
          d == 'ltr' &&
            (dt[0].level == 1 &&
              (Yt = u.match(/^\s+/)) &&
              ((dt[0].from = Yt[0].length),
              dt.unshift(new s(0, 0, Yt[0].length))),
            de(dt).level == 1 &&
              (Yt = u.match(/\s+$/)) &&
              ((de(dt).to -= Yt[0].length),
              dt.push(new s(0, b - Yt[0].length, b)))),
          d == 'rtl' ? dt.reverse() : dt
        );
      };
    })();
      ...
      if (It == null) {
        ...
        _(e, c('span', [t, document.createTextNode('x')])),
          e.firstChild.offsetHeight != 0 &&
            (It = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(M && j < 8));
      }
      var n = It
        ? c('span', '​')
        : c(
...
`,
    ...
    function g(e, t, n) {
      if ((n === void 0 && (n = null), !(this instanceof g)))
        return new g(e, t, n);
    ...
    function le(e, t) {
      ...
      return t.line > n
        ? g(n, K(e, n).text.length)
        : ga(t, K(e, t.line).text.length);
    }
    function ga(e, t) {
      var n = e.ch;
    ...
    (qt.prototype.lookAhead = function (e) {
      ...
      (qt.fromSaved = function (e, t, n) {
        return t instanceof Hn
          ? new qt(e, Qt(e.mode, t.state), n, t.lookAhead)
          : new qt(e, Qt(e.mode, t), n);
      }),
            ...
            (n.state = !0),
              mo(
                ...
                function (m, C) {
                  for (var N = h; b < m; ) {
                    var O = i[h];
                    O > m && i.splice(h, 1, m, i[h + 1], O),
                      (h += 2),
                      (b = Math.min(m, O));
                  }
                  if (C)
                    if (d.opaque)
                      i.splice(N, h - N, m, 'overlay ' + C), (h = N + 2);
                    else
                      for (; N < h; N += 2) {
                        var z = i[N + 1];
                        i[N + 1] = (z ? z + ' ' : '') + 'overlay ' + C;
    ...
    function go(e, t, n, r) {
      ...
      for (r && (d = []); (r || u.pos < t.ch) && !u.eol(); )
        (u.start = u.pos),
          (l = bi(o, u, s.state)),
          r && d.push(new vo(u, l, Qt(i.mode, s.state)));
      ...
      if (e)
        for (var i = 0; i < e.length; ++i) {
          ...
          if (
            ...
            (r || (r = [])).push(
              new Bn(l, s ? null : o.from - t, o.to == null ? null : o.to - t)
            );
          }
        }
      return r;
    ...
    function xi(e, t) {
      ...
      if (!u) {
        ...
        if (F > 0 && a)
          for (var H = 0; H < a.length; ++H)
            a[H].to == null &&
              (P || (P = [])).push(new Bn(a[H].marker, null, null));
    ...
    function No(e, t) {
      ...
      for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
        ...
        (r.pos = 0),
          ...
          In(e.display.measure) &&
            (l = Et(o, e.doc.direction)) &&
            (r.addToken = Fa(r.addToken, l)),
          (r.map = []);
        var a = t != e.display.externalMeasured && Ne(o);
        Wa(o, r, ho(e, o, a)),
          o.styleClasses &&
            (o.styleClasses.bgClass &&
              (r.bgClass = B(o.styleClasses.bgClass, r.bgClass || '')),
            o.styleClasses.textClass &&
              (r.textClass = B(o.styleClasses.textClass, r.textClass || ''))),
          r.map.length == 0 &&
      ...
      return (
        ...
        r.pre.className &&
          (r.textClass = B(r.pre.className, r.textClass || '')),
        r
      );
    }
    function Pa(e) {
...
`
    ...
    function Wa(e, t, n) {
      ...
      for (
        var a = i.length, s = 0, u = 1, d = '', h, b, m = 0, C, N, O, z, F;
        ;
        ...
        if (m == s) {
          ...
          for (var P = [], H = void 0, Z = 0; Z < r.length; ++Z) {
            var Y = r[Z],
              ve = Y.marker;
            if (ve.type == 'bookmark' && Y.from == s && ve.widgetNode)
              P.push(ve);
            else if (
              Y.from <= s &&
              (Y.to == null ||
                Y.to > s ||
                (ve.collapsed && Y.to == s && Y.from == s))
            ) {
              if (
                (Y.to != null &&
                  Y.to != s &&
                ...
                ve.endStyle &&
                  Y.to == m &&
                  (H || (H = [])).push(ve.endStyle, Y.to),
                ve.title && ((F || (F = {})).title = ve.title),
                ve.attributes)
              )
                for (var Fe in ve.attributes)
                  (F || (F = {}))[Fe] = ve.attributes[Fe];
              ve.collapsed && (!z || wi(z.marker, ve) < 0) && (z = Y);
            } else Y.from > s && m > Y.from && (m = Y.from);
          }
          if (H)
            for (var ot = 0; ot < H.length; ot += 2)
              H[ot + 1] == m && (N += ' ' + H[ot]);
          if (!z || z.from == s)
            for (var Ge = 0; Ge < P.length; ++Ge) Do(t, 0, P[Ge]);
          if (z && (z.from || 0) == s) {
            if (
              (Do(
                t,
                (z.to == null ? a + 1 : z.to) - s,
                z.marker,
                z.from == null
              ),
              z.to == null)
    ...
    function _a(e) {
      Fr
        ? Fr.ops.push(e)
        : (e.ownsGroup = Fr = { ops: [e], delayedCallbacks: [] });
    }
    function Ha(e) {
    ...
    function rt(e, t) {
      ...
      if (n.length) {
        var r = Array.prototype.slice.call(arguments, 2),
          i;
        Fr
          ? (i = Fr.delayedCallbacks)
          : sn
            ? (i = sn)
            : ((i = sn = []), setTimeout(Ra, 0));
        for (
          var o = function (a) {
              i.push(function () {
    ...
    function Eo(e, t, n) {
      if ((Io(e, t.line, t, n, !0), t.rest))
        for (var r = 0; r < t.rest.length; r++) Io(e, t.rest[r], t, n, !1);
    }
    ...
    function Wr(e, t) {
      ...
      r && !r.text
        ? (r = null)
        : r && r.changes && (Oo(e, r, n, Pi(e)), (e.curOp.forceUpdate = !0)),
        r || (r = Ya(e, t));
      var i = Wo(r, t, n);
      return {
        line: t,
    ...
    function Ja(e, t, n, r) {
      ...
      if (o.nodeType == 3) {
        for (var d = 0; d < 4; d++) {
          ...
          for (
            ...
            q(t.line.text.charAt(i.coverStart + a));
      ...
      for (
        var m = u.top - t.rect.top,
          C = u.bottom - t.rect.top,
          N = (m + C) / 2,
          O = t.view.measure.heights,
          z = 0;
        z < O.length - 1 && !(N < O[z]);
        z++
      );
      ...
      return (
        !u.left && !u.right && (H.bogus = !0),
        e.options.singleCursorHeightPerLine || ((H.rtop = m), (H.rbottom = C)),
        H
      );
    }
    function Qa(e, t) {
    ...
    function Xn(e, t, n, r, i) {
      ...
      var l = er(t);
      if (
        (r == 'local' ? (l += jn(e.display)) : (l -= e.display.viewOffset),
        r == 'page' || r == 'window')
      ) {
    ...
    function Oi(e, t, n) {
      ...
      var i = Gt(r, n),
        o = r.first + r.size - 1;
      if (i > o)
        return Ai(r.first + r.size - 1, K(r, o).text.length, null, 1, 1);
      t < 0 && (t = 0);
      for (var l = K(r, i); ; ) {
        var a = Va(e, l, i, t, n),
    ...
    function $a(e, t, n, r, i, o, l) {
      var a = he(
          function (h) {
            ...
            return zi(
              Ht(
                e,
                g(n, m ? b.to : b.from, m ? 'before' : 'after'),
                'line',
                t,
                r
              ),
      ...
      if (a > 0) {
        var u = s.level != 1,
          d = Ht(
            e,
            g(n, u ? s.from : s.to, u ? 'after' : 'before'),
            'line',
            t,
            r
          );
    ...
    function Zo(e) {
      var t = _r(e.display),
        ...
        r =
          n && Math.max(5, e.display.scroller.clientWidth / Hr(e.display) - 3);
      return function (i) {
    ...
    function kr(e, t, n, r) {
      ...
      if (r && s.xRel > 0 && (u = K(e.doc, s.line).text).length == s.ch) {
        ...
        s = g(
          s.line,
          Math.max(0, Math.round((o - Fo(e.display).left) / Hr(e.display)) - d)
        );
      }
      return s;
    }
        ...
        function Lt(Qe, kt, at) {
          var tt = Yo(e, Y, null, Qe),
            ...
            Ye =
              at == 'after'
                ? tt.begin
                : tt.end - (/\s/.test(Y.text.charAt(tt.end - 1)) ? 2 : 1);
          return Ge(Ye, Ve)[Ve];
        }
      ...
      (e.state.delayingBlurEvent = !0),
        setTimeout(function () {
          e.state.delayingBlurEvent &&
            ((e.state.delayingBlurEvent = !1), e.state.focused && Br(e));
        }, 100);
    }
    function Hi(e, t) {
      e.state.delayingBlurEvent &&
    ...
    function Qn(e) {
      for (
        ...
        if (!a.hidden) {
          ...
          if (
            (m > 0.005 || m < -0.005) &&
            (i < r && (o -= m), Ft(a.line, u), $o(a.line), a.rest)
          )
      ...
      if (n && n.ensure) {
        ...
        a < o
          ...
          : Math.min(s, t.lastLine()) >= l &&
            ((o = Gt(t, er(K(t, s)) - e.wrapper.clientHeight)), (l = s));
      }
    ...
    function is(e, t, n, r) {
      ...
      !e.options.lineWrapping &&
        ...
        (t = t.ch
          ? g(t.line, t.sticky == 'before' ? t.ch - 1 : t.ch, 'after')
          : t));
      for (var o = 0; o < 5; o++) {
        var l = !1,
          a = Ht(e, t),
        ...
        if (
          (u.scrollTop != null &&
            (pn(e, u.scrollTop), Math.abs(e.doc.scrollTop - d) > 1 && (l = !0)),
          u.scrollLeft != null &&
            (Cr(e, u.scrollLeft),
    ...
    function os(e, t) {
      var n = Bi(e, t);
      n.scrollTop != null && pn(e, n.scrollTop),
    ...
    function pn(e, t) {
      Math.abs(e.doc.scrollTop - t) < 2 ||
        (we || Ui(e, { top: t }), tl(e, t, !0), we && Ui(e), yn(e, 100));
    }
    function tl(e, t, n) {
      (t = Math.max(
        0,
    ...
    function hs(e) {
      ...
      if (o)
        for (var a = 0; a < o.length; ++a)
          o[a].lines.length || _e(o[a], 'hide');
      if (l)
        for (var s = 0; s < l.length; ++s)
          l[s].lines.length && _e(l[s], 'unhide');
    ...
    function yn(e, t) {
      e.doc.highlightFrontier < e.display.viewTo &&
        e.state.highlight.set(t, We(ps, e));
    }
    function ps(e) {
      var t = e.doc;
    ...
    function Ki(e, t) {
      ...
      ts(e, o, l),
        (n.viewOffset = er(K(e.doc, n.viewFrom))),
        ...
        if (!r || !e.options.lineWrapping || t.oldDisplayWidth == xr(e)) {
          if (
            (n &&
              n.top != null &&
              (n = {
                top: Math.min(e.doc.height + Li(e.display) - Mi(e), n.top),
              }),
    ...
    function ms(e, t, n) {
      ...
      function a(C) {
        var N = C.nextSibling;
        return (
          W && xe && e.display.currentWheelTarget == C
      ...
      for (var s = r.view, u = r.viewFrom, d = 0; d < s.length; d++) {
        ...
        if (!h.hidden)
          if (!h.node || h.node.parentNode != o) {
            ...
            h.changes &&
              (se(h.changes, 'gutter') > -1 && (m = !1), Oo(e, h, u, n)),
              m &&
                (L(h.lineNumber),
                h.lineNumber.appendChild(
                  document.createTextNode(p(e.options, u))
                )),
    ...
    function qi(e, t) {
      (e.display.sizer.style.minHeight = t.docHeight + 'px'),
        ...
        (e.display.gutters.style.height =
          t.docHeight + e.display.barHeight + jt(e) + 'px');
    }
    function ll(e) {
      var t = e.display,
        n = t.view;
      if (
        ...
        for (
          var r = Ei(t) - t.scroller.scrollLeft + e.doc.scrollLeft,
    ...
    function fl(e, t) {
      ...
      if ((r && s) || (i && u)) {
        ...
        if (i && o != null) {
          ...
          m < 0
            ? (C = Math.max(0, C + m - 50))
            : (N = Math.min(e.doc.height, N + m + 50)),
            Ui(e, { top: C, bottom: N });
        }
        ti < 20 &&
          t.deltaMode !== 0 &&
              ...
              setTimeout(function () {
                if (l.wheelStartX != null) {
                  var O = a.scrollLeft - l.wheelStartX,
                    ...
                    F =
                      (z && l.wheelDY && z / l.wheelDY) ||
                      (O && l.wheelDX && O / l.wheelDX);
                  (l.wheelStartX = l.wheelStartY = null),
                    F && ((rr = (rr * ti + F) / (ti + 1)), ++ti);
                }
              }, 200))
    ...
    function dl(e, t, n) {
      return e.line == t.line
        ? g(n.line, e.ch - t.ch + n.ch)
        : g(n.line + (e.line - t.line), e.ch);
    }
    function ws(e, t, n) {
    ...
    function Zi(e, t, n, r) {
      ...
      if (t.full)
        ...
        if (u.length == 1)
          o(d, d.text.slice(0, a.ch) + b + d.text.slice(s.ch), m);
        else {
        ...
        o(d, d.text.slice(0, a.ch) + u[0] + h.text.slice(s.ch), i(0)),
          e.remove(a.line + 1, C);
      else {
        o(d, d.text.slice(0, a.ch) + u[0], i(0)),
          o(h, b + h.text.slice(s.ch), m);
    ...
    function yl(e, t, n, r) {
      ...
      if (
        ...
        (a = de(l.changes)),
          S(t.from, t.to) == 0 && S(t.from, a.to) == 0
            ? (a.to = hr(t))
            : l.changes.push(Ji(e, t));
      else {
        var s = de(i.done);
        for (
          (!s || !s.ranges) && ni(e.sel, i.done),
    ...
    function ii(e, t, n, r, i) {
      i == null && (i = e.cm && (e.cm.display.shift || e.extend)),
        ct(e, new At([Qi(e.sel.primary(), t, n, i)], 0), r);
    }
    function xl(e, t, n) {
      for (
      ...
      var r = {
        ...
        update: function (i) {
          ...
          for (var o = 0; o < i.length; o++)
            this.ranges[o] = new De(le(e, i[o].anchor), le(e, i[o].head));
        },
        origin: n && n.origin,
      };
      return (
    ...
    function oi(e, t, n) {
      (ht(e, 'beforeSelectionChange') ||
        (e.cm && ht(e.cm, 'beforeSelectionChange'))) &&
        (t = Ns(e, t, n));
      var r =
        (n && n.bias) ||
        (S(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
      Sl(e, Tl(e, t, r, !0)),
        !(n && n.scroll === !1) &&
          e.cm &&
    ...
    function Tl(e, t, n, r) {
      for (var i, o = 0; o < t.ranges.length; o++) {
        ...
        (i || s != l.anchor || u != l.head) &&
          (i || (i = t.ranges.slice(0, o)), (i[o] = new De(s, u)));
      }
        ...
        for (var l = 0; l < o.markedSpans.length; ++l) {
          ...
          if (
            ...
            if (n) {
              ...
              if (
                ((r < 0 ? d : u) &&
                  (h = Ll(e, h, -r, h && h.line == t.line ? o : null)),
                h &&
                  h.line == t.line &&
                  (b = S(h, n)) &&
                  (r < 0 ? b < 0 : b > 0))
            ...
            return (
              (r < 0 ? u : d) && (m = Ll(e, m, r, m.line == t.line ? o : null)),
              m ? Gr(e, m, t, r, i) : null
            );
          }
        }
    ...
    function qr(e, t, n) {
      ...
      if (
        !(
          (ht(e, 'beforeChange') || (e.cm && ht(e.cm, 'beforeChange'))) &&
          ((t = Nl(e, t, !0)), !t)
        )
      ) {
    ...
    function Dl(e, t) {
      if (!(t.text.length == 1 && t.text[0] == '' && S(t.from, t.to) == 0)) {
        ...
        var r = [];
        pr(e, function (i, o) {
          !o && se(r, i.history) == -1 && (Pl(i.history, t), r.push(i.history)),
            xn(i, t, null, xi(i, t));
        });
      }
    }
            ...
            var h = ht(e, 'beforeChange') || (e.cm && ht(e.cm, 'beforeChange')),
              b = function (N) {
                ...
                xn(e, O, z, bl(e, O)),
                  !N &&
                    e.cm &&
                    e.cm.scrollIntoView({ from: O.from, to: hr(O) });
                var F = [];
                pr(e, function (P, H) {
                  !H &&
                    se(F, P.history) == -1 &&
                    (Pl(P.history, O), F.push(P.history)),
                    xn(P, O, null, bl(P, O));
                });
              },
      ...
      if (
        ...
        (e.sel = new At(
          st(e.sel.ranges, function (i) {
            return new De(
              g(i.anchor.line + t, i.anchor.ch),
              g(i.head.line + t, i.head.ch)
            );
          }),
          e.sel.primIndex
        )),
    ...
    function Ds(e, t, n) {
      ...
      if (h || d) {
        ...
        h && rt(e, 'change', e, b),
          d && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(b);
      }
    ...
    function zl(e, t, n, r) {
      for (var i = 0; i < e.length; ++i) {
        ...
        for (var s = 0; s < o.changes.length; ++s) {
          var u = o.changes[s];
          if (n < u.from.line)
            (u.from = g(u.from.line + r, u.from.ch)),
              (u.to = g(u.to.line + r, u.to.ch));
          else if (t <= u.to.line) {
            l = !1;
            break;
          }
    ...
    Sn.prototype = {
      ...
      removeInner: function (e, t) {
        ...
        if (
          this.size - t < 25 &&
          (this.children.length > 1 || !(this.children[0] instanceof kn))
        ) {
          var a = [];
          this.collapse(a),
            (this.children = [new kn(a)]),
          ...
          n &&
            Tt(n, function () {
              (n.curOp.forceUpdate = !0),
                El(n, r, i),
                rt(n, 'lineWidgetChanged', n, e, Ne(r));
            }));
      }),
      pt(Cn);
    function El(e, t, n) {
    ...
    (vr.prototype.clear = function () {
      ...
      (vr.prototype.find = function (e, t) {
        ...
        for (var n, r, i = 0; i < this.lines.length; ++i) {
          ...
          if (l.from != null && ((n = g(t ? o : Ne(o), l.from)), e == -1))
            return n;
      ...
      (vr.prototype.changed = function () {
        ...
        !t ||
          ...
          Tt(r, function () {
            ...
            if (
              (l &&
                (Ro(l), (r.curOp.selectionChanged = r.curOp.forceUpdate = !0)),
    ...
    function Xr(e, t, n, r, i) {
      ...
      var o = new vr(e, i),
        l = S(t, n);
      if ((r && V(r, o, !1), l > 0 || (l == 0 && o.clearWhenEmpty !== !1)))
        return o;
      if (
        (o.replacedWith &&
          ((o.collapsed = !0),
        ...
        if (
          To(e, t.line, t, n, o) ||
          (t.line != n.line && To(e, n.line, t, n, o))
        )
          throw new Error(
      ...
      if (
        (e.iter(a, n.line + 1, function (h) {
          s &&
            ...
            _t(h) == s.display.maxLine &&
            (u = !0),
            o.collapsed && a != t.line && Ft(h, 0),
            ka(
              h,
              new Bn(o, a == t.line ? t.ch : null, a == n.line ? n.ch : null),
              e.cm && e.cm.curOp
            ),
            ++a;
        }),
    ...
    (xt.prototype = k(Sn.prototype, {
      ...
      setSelections: it(function (e, t, n) {
        if (e.length) {
          ...
          t == null && (t = Math.min(e.length - 1, this.sel.primIndex)),
            ct(this, Bt(this.cm, r, t), n);
        }
      }),
      addSelection: it(function (e, t, n) {
        var r = this.sel.ranges.slice(0);
        r.push(new De(le(this, e), le(this, t || e))),
          ct(this, Bt(this.cm, r, r.length - 1), n);
      }),
      ...
      replaceSelections: it(function (e, t, n) {
        ...
        for (
          var a = t && t != 'end' && ws(this, r, t), s = r.length - 1;
          s >= 0;
          s--
        )
          qr(this, r[s]);
          ...
          n.gutterMarkers &&
            ...
            wn(t, n, 'gutter', function () {
              return (
                ...
                R(n.gutterMarkers) && (n.gutterMarkers = null),
                !0
              );
            });
        });
...
`
                ...
                a = function () {
                  ++l == i &&
                    nt(t, function () {
                      ...
                      qr(t.doc, m),
                        kl(t.doc, dr(le(t.doc, n), le(t.doc, hr(m))));
                    })();
                },
                s = function (m, C) {
                  if (
                    t.options.allowDropFileTypes &&
                    se(t.options.allowDropFileTypes, m.type) == -1
                  ) {
                    a();
                    return;
                  }
            ...
            try {
              ...
              if (d) {
                ...
                if (
                  ...
                  for (var b = 0; b < h.length; ++b)
                    jr(t.doc, '', h[b].anchor, h[b].head, 'drag');
    ...
    function Ul(e, t) {
      ...
      return n == null || e.altGraphKey
        ? !1
        : (e.keyCode == 3 && e.code && (n = e.code), Kl(n, e, t));
    }
    function ui(e) {
    ...
    function Us(e, t, n, r) {
      ...
      if (e.doc.direction == 'rtl' || l.level == 1) {
        ...
        if (
          b != null &&
          (h ? b <= l.to && b <= d.end : b >= l.from && b >= d.begin)
        ) {
      ...
      var C = function (z, F, P) {
          for (
            var H = function (Fe, ot) {
              return ot
                ? new g(n.line, a(Fe, 1), 'before')
                : new g(n.line, Fe, 'after');
            };
            z >= 0 && z < i.length;
            z += F
          ) {
            ...
            if (
              (Z.from <= ve && ve < Z.to) ||
              ((ve = Y ? Z.from : a(Z.to, -1)), P.begin <= ve && ve < P.end)
            )
              return H(ve, Y);
          }
        },
        ...
        return Tt(e, function () {
          for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++)
            if (t[r].empty()) {
              ...
              if (o) {
                if (
                  (i.ch == o.length && (i = new g(i.line, i.ch - 1)), i.ch > 0)
                )
...
`,
    ...
    function tu(e, t, n, r) {
      ...
      r.addNew
        ? a == -1
          ? ((a = u.length),
            ct(o, Bt(e, u.concat([l]), a), { scroll: !1, origin: '*mouse' }))
          : u.length > 1 && u[a].empty() && r.unit == 'char' && !r.extend
            ? (ct(o, Bt(e, u.slice(0, a).concat(u.slice(a + 1)), 0), {
                scroll: !1,
                origin: '*mouse',
              }),
              (s = o.sel))
          ...
          if (((h = P), r.unit == 'rectangle')) {
            for (
              ...
              Fe == ot
                ...
                : wt.length > Qe &&
                  H.push(new De(g(Ge, Qe), g(Ge, yt(wt, ot, Z))));
            }
            H.length || H.push(new De(n, n)),
              ct(o, Bt(e, s.ranges.slice(0, a).concat(H), a), {
                origin: '*mouse',
                scroll: !1,
              }),
              e.scrollIntoView(P);
      ...
      var z = nt(e, function (P) {
        ...
        F = nt(e, O);
      (e.state.selectingText = F),
        E(i.wrapper.ownerDocument, 'mousemove', z),
        E(i.wrapper.ownerDocument, 'mouseup', F);
    }
    function ru(e, t) {
      var n = t.anchor,
        r = t.head,
    ...
    function iu(e) {
      ...
      (e.defineOption = n),
        ...
        n('lineSeparator', null, function (r, i) {
          if (((r.doc.lineSep = i), !!i)) {
            ...
            for (var a = o.length - 1; a >= 0; a--)
              jr(r.doc, i, o[a], g(o[a].line, o[a].ch + i.length));
          }
        }),
        n(
          'specialChars',
        ...
        n(
          ...
          !0,
          function (r, i) {
            (r.display.gutters.style.left = i ? Ei(r.display) + 'px' : '0'),
              r.refresh();
          },
          !0
        ),
        ...
        n('readOnly', !1, function (r, i) {
          i == 'nocursor' && (Br(r), r.display.input.blur()),
    ...
    function zn(e, t, n, r) {
      var i = e.doc,
        o;
      n == null && (n = 'add'),
        n == 'smart' && (i.mode.indent ? (o = ln(e, t).state) : (n = 'prev'));
      ...
      if (e.options.indentWithTabs)
        for (var m = Math.floor(d / l); m; --m) (b += l), (h += '	');
      if ((b < d && (h += Ue(d - b)), h != u))
        return (
          jr(i, h, g(t, 0), g(t, u.length), '+input'), (a.stateAfter = null), !0
        );
...
`) == t
          ...
          if (r.ranges.length % Rt.text.length == 0) {
            u = [];
            for (var d = 0; d < Rt.text.length; d++)
              u.push(o.splitLines(Rt.text[d]));
          }
        } else
        ...
        m.empty() &&
          (n && n > 0
            ...
            : e.state.overwrite && !a
              ? (N = g(
                  N.line,
                  Math.min(K(o, N.line).text.length, N.ch + de(s).length)
                ))
              : a &&
                Rt &&
                Rt.lineWise &&
...
`) &&
    ...
    function su(e) {
      ...
      (e.prototype = {
        ...
        setOption: function (r, i) {
          ...
          (o[r] == i && r != 'mode') ||
            ((o[r] = i),
            t.hasOwnProperty(r) && nt(this, t[r])(this, i, l),
            _e(this, 'optionChange', this, r));
        },
          ...
          for (var i = this.doc.sel.ranges, o = -1, l = 0; l < i.length; l++) {
            ...
            if (a.empty())
              a.head.line > o &&
                ...
                (o = a.head.line),
                l == this.doc.sel.primIndex && Rr(this));
            else {
              var s = a.from(),
                u = a.to(),
                d = Math.max(o, s.line);
              ...
              s.ch == 0 &&
                i.length == b.length &&
                b[l].from().ch > 0 &&
                Vi(this.doc, l, new De(s, b[l].to()), Ie);
            }
          }
        }),
        ...
        getStateAfter: function (r, i) {
          var o = this.doc;
          return (
            (r = Dt(o, r ?? o.first + o.size - 1)), ln(this, r + 1, i).state
          );
        },
        ...
        lineAtHeight: function (r, i) {
          return (
            ...
            Gt(this.doc, r + this.display.viewOffset)
          );
        },
        heightAtLine: function (r, i, o) {
          ...
          return (
            Xn(this, a, { top: 0, left: 0 }, i || 'page', o || l).top +
        ...
        refresh: vt(function () {
          ...
          bt(this),
            ...
            Gi(this.display),
            (r == null ||
              Math.abs(r - _r(this.display)) > 0.5 ||
    ...
    function ao(e, t, n, r, i) {
      ...
      function u() {
        var F = t.line + s;
        return F < e.first || F >= e.first + e.size
          ? !1
          : ((t = new g(F, t.ch, t.sticky)), (a = K(e, F)));
      }
      function d(F) {
        var P;
        if (r == 'codepoint') {
          ...
          if (isNaN(H)) P = null;
            ...
            P = new g(
              t.line,
              Math.max(0, Math.min(a.text.length, t.ch + n * (Z ? 2 : 1))),
              -n
            );
          }
    ...
    function sa(e, t, n, r) {
      ...
      if (r == 'page') {
        var a = Math.min(
            ...
            Ze(e).innerHeight || i(e).documentElement.clientHeight
          ),
...
`));
      ...
      (ze.prototype.focus = function () {
        this.cm.options.readOnly != 'nocursor' &&
          ((!this.selectionInEditor() ||
            y(this.div.ownerDocument) != this.div) &&
      ...
      (ze.prototype.pollContent = function () {
        ...
        if (
          (r.ch == 0 &&
            r.line > e.firstLine() &&
            (r = g(r.line - 1, K(e.doc, r.line - 1).length)),
        ...
        if (
          (s == t.view.length - 1
            ...
            : ((u = Ne(t.view[s + 1].line) - 1),
              (d = t.view[s + 1].node.previousSibling)),
          !a)
        )
          return !1;
        for (
          var h = e.doc.splitLines(fu(e, a, d, l, u)),
            b = Vt(e.doc, g(l, 0), g(u, K(e.doc, u).text.length));
        ...
        for (
          var F = de(h),
            P = de(b),
            H = Math.min(
              F.length - (h.length == 1 ? m : 0),
              P.length - (b.length == 1 ? m : 0)
            );
          C < H &&
          F.charCodeAt(F.length - C - 1) == P.charCodeAt(P.length - C - 1);
        ...
        if (h.length > 1 || h[0] || S(Z, Y))
          return jr(e.doc, h, Z, Y, '+input'), !0;
      }),
    ...
    function fu(e, t, n, r, i) {
      ...
      function b(m) {
        if (m.nodeType == 1) {
          ...
          m.nodeType == 3 &&
            h(m.nodeValue.replace(/\u200b/g, '').replace(/\u00a0/g, ' '));
      }
    ...
    function hi(e, t, n) {
      ...
      if (t == e.display.lineDiv) {
        if (((r = e.display.lineDiv.childNodes[n]), !r))
          return Qr(e.clipPos(g(e.display.viewTo - 1)), !0);
        (t = null), (n = 0);
      } else
    ...
    function cu(e, t, n) {
      ...
      if (h) return Qr(h, i);
      for (
        var b = a.nextSibling, m = l ? l.nodeValue.length - n : 0;
        b;
        b = b.nextSibling
      ) {
      ...
      for (var C = a.previousSibling, N = n; C; C = C.previousSibling) {
        if (((h = d(C, C.firstChild, -1)), h))
          return Qr(g(h.line, h.ch + N), i);
...
`)),
      ...
      (Je.prototype.focus = function () {
        if (
          this.cm.options.readOnly != 'nocursor' &&
          (!te || y(this.textarea.ownerDocument) != this.textarea)
        )
          try {
            this.textarea.focus();
          } catch {}
...
`) > -1
    ...
    return (
      ...
      (Ke.defineMode = function (e) {
        !Ke.defaults.mode && e != 'null' && (Ke.defaults.mode = e),
  ...
  (function (I) {
    ...
    I.defineMode('css', function ($, X) {
      ...
      function Ie(k, A) {
        ...
        if (/\d/.test(T) || (T == '.' && k.eat(/\d/)))
          return k.eatWhile(/[\w.%]/), ie('number', 'unit');
        if (T === '-') {
          if (/[\d.]/.test(k.peek()))
            return k.eatWhile(/[\w.%]/), ie('number', 'unit');
          if (k.match(/^-[\w\\\-]*/))
            return (
              k.eatWhile(/[\w\\\-]/),
              k.match(/^\s*:/, !1)
                ? ie('variable-2', 'variable-definition')
                : ie('variable-2', 'variable')
            );
          ...
          return /[,+>*\/]/.test(T)
            ...
            : T == '.' && k.match(/^-?[_a-z][_a-z0-9-]*/i)
              ...
              : /[:;{}\[\]\(\)]/.test(T)
                ? ie(null, T)
                : k.match(/^[\w-.]+(?=\()/)
                  ? (/^(url(-prefix)?|domain|regexp)$/i.test(k.current()) &&
                      (A.tokenize = Ot),
      ...
      return (
        (Oe.top = function (k, A, T) {
          ...
          if (/^@(media|supports|(-moz-)?document|import)$/i.test(k))
            return Te(T, A, 'atBlock');
          if (/^@(font-face|counter-style)/i.test(k))
            return (T.stateArg = k), 'restricted_atBlock_before';
        ...
        (Oe.pseudo = function (k, A, T) {
          return k == 'meta'
            ? 'pseudo'
            : k == 'word'
              ? ((ge = 'variable-3'), T.context.type)
              : de(k, A, T);
        }),
        (Oe.documentTypes = function (k, A, T) {
          return k == 'word' && c.hasOwnProperty(A.current())
            ? ((ge = 'tag'), T.context.type)
            : Oe.atBlock(k, A, T);
        }),
          ...
          return k == '}'
            ...
            : k == 'word'
              ? ((T.stateArg == '@font-face' &&
                  !B.hasOwnProperty(A.current().toLowerCase())) ||
                (T.stateArg == '@counter-style' &&
                  !Q.hasOwnProperty(A.current().toLowerCase()))
                  ? (ge = 'error')
                  : (ge = 'property'),
                'maybeprop')
              : 'restricted_atBlock';
        ...
        (Oe.at = function (k, A, T) {
          return k == ';'
            ...
            : k == '{' || k == '}'
              ? st(k, A, T)
              : (k == 'word' ? (ge = 'tag') : k == 'hash' && (ge = 'builtin'),
                'at');
        }),
          ...
          I.defineMode('xml', function (He, $e) {
            ...
            function Ae(c) {
              return function (w, x) {
                for (var v; (v = w.next()) != null; ) {
                  if (v == '<')
                    return (x.tokenize = Ae(c + 1)), x.tokenize(w, x);
                  if (v == '>')
                    if (c == 1) {
                      x.tokenize = ue;
                      break;
            ...
            function J(c, w, x) {
              (this.prev = c.context),
                ...
                (this.startOfLine = x),
                (M.doNotIndent.hasOwnProperty(w) ||
            ...
            function xe(c, w) {
              for (var x; ; ) {
                if (
                  !c.context ||
                  ((x = c.context.tagName),
                  !M.contextGrabbers.hasOwnProperty(re(x)) ||
                    !M.contextGrabbers[re(x)].hasOwnProperty(re(w)))
                )
                  return;
                te(c);
              }
            ...
            function me(c, w, x) {
              return c == 'equals'
                ? L
                : (M.allowMissing || (G = 'error'), X(c, w, x));
            }
            function L(c, w, x) {
              return c == 'string'
                ? _
            ...
            return {
              ...
              token: function (c, w) {
                if (
                  (!w.tagName && c.sol() && (w.indented = c.indentation()),
                  c.eatSpace())
                )
                  return null;
                ee = null;
                ...
                return (
                  (x || ee) &&
                    x != 'comment' &&
                    ((G = null),
                    (w.state = w.state(ee || x, c, w)),
                    G && (x = G == 'error' ? x + ' error' : G)),
                  x
                );
              },
              indent: function (c, w, x) {
                ...
                if (c.tokenize != ce && c.tokenize != ue)
                ...
                if (y && y[1])
                  for (; v; )
                    if (v.tagName == y[2]) {
                      v = v.prev;
                      break;
                    } else if (M.implicitlyClosed.hasOwnProperty(re(v.tagName)))
                      v = v.prev;
                    else break;
                else if (y)
                  for (; v; ) {
              ...
              xmlCurrentContext: function (c) {
                for (var w = [], x = c.context; x; x = x.prev)
                  w.push(x.tagName);
                return w.reverse();
              },
            };
            ...
            I.mimeModes.hasOwnProperty('text/html') ||
              I.defineMIME('text/html', { name: 'xml', htmlMode: !0 });
        });
      })()),
    fa.exports
  );
        ...
        (function (I) {
          ...
          I.defineMode('javascript', function (Pe, we) {
            ...
            function J(f, p) {
              var g = f.next();
              if (g == '"' || g == "'")
                return (p.tokenize = te(g)), p.tokenize(f, p);
              if (g == '.' && f.match(/^\d[\d_]*(?:[eE][+\-]?[\d_]+)?/))
                return re('number', 'number');
              if (g == '.' && f.match('..')) return re('spread', 'meta');
              if (/[\[\]{}\(\),;\:\.]/.test(g)) return re(g);
              if (g == '=' && f.eat('>')) return re('=>', 'operator');
              if (g == '0' && f.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/))
                return re('number', 'number');
              if (/\d/.test(g))
                return (
              ...
              if (g == '#' && f.peek() == '!')
                return f.skipToEnd(), re('meta', 'meta');
              ...
              if (ue.test(g))
                return (
                  ...
                  g == '?' && f.eat('.')
                    ? re('.')
                    : re('operator', 'operator', f.current())
                );
              if (ee.test(g)) {
                f.eatWhile(ee);
                var S = f.current();
            ...
            function te(f) {
              return function (p, g) {
                var S = !1,
                  oe;
                if (Ce && p.peek() == '@' && p.match(ce))
                  return (g.tokenize = J), re('jsonld-keyword', 'meta');
                for (; (oe = p.next()) != null && !(oe == f && !S); )
                  S = !S && oe == '\\';
            ...
            function X(f, p) {
              if (!j) return !1;
              for (var g = f.localVars; g; g = g.next)
                if (g.name == p) return !0;
              for (var S = f.context; S; S = S.prev)
                for (var g = S.vars; g; g = g.next) if (g.name == p) return !0;
            }
            ...
            function x(f) {
              ...
              if (((L.marked = 'def'), !!j)) {
                ...
                we.globalVars &&
                  !w(f, p.globalVars) &&
                  (p.globalVars = new B(f, p.globalVars));
              }
            }
            function v(f, p) {
              if (p)
                if (p.block) {
                  ...
                  return w(f, p.vars) ? p : new D(p.prev, new B(f, p.vars), !1);
              else return null;
            }
            function y(f) {
              return (
                      ...
                      : f == 'debugger'
                        ...
                        : f == '{'
                          ...
                          : f == ';'
                            ? c()
                            : f == 'if'
                              ? (L.state.lexical.info == 'else' &&
                                  L.state.cc[L.state.cc.length - 1] == U &&
                                  L.state.cc.pop()(),
                                c(V('form'), Mt, se, U, zr))
                              : f == 'function'
                                ? c(Kt)
            ...
            function st(f) {
              if (f == '}')
                return (L.marked = 'string-2'), (L.state.tokenize = Be), c(de);
            }
            function qe(f) {
            ...
            function ne(f, p) {
              ...
              if (f == 'variable' || L.style == 'keyword') {
                if (((L.marked = 'property'), p == 'get' || p == 'set'))
                  return c(q);
                var g;
                return (
                  W &&
                ...
                if (f == 'number' || f == 'string')
                  return (
                    (L.marked = Ce ? 'property' : L.style + ' property'), c(be)
                  );
            ...
            function Et(f) {
              if (W && f == ':')
                return L.stream.match(/^\s*\w+\s+is\b/, !1)
                  ? c(ie, Pn, E)
                  : c(E);
            }
            function Pn(f, p) {
            ...
            function E(f, p) {
              ...
              if (f == 'variable' || p == 'void')
                return (L.marked = 'type'), c(pt);
              if (p == '|' || p == '&') return c(E);
            ...
            function En(f) {
              if (f == '}')
                return (L.marked = 'string-2'), (L.state.tokenize = Be), c(je);
            }
            function ht(f, p) {
            ...
            function zr(f, p) {
              if (f == 'keyword b' && p == 'else')
                return c(V('form', 'else'), se, U);
            }
            function In(f, p) {
            ...
            function Pr(f, p) {
              ...
              if (p == 'extends' || p == 'implements' || (W && f == ','))
                return (
                  p == 'implements' && (L.marked = 'keyword'), c(W ? E : ie, Pr)
                );
            ...
            function Ct(f, p) {
              ...
              if (f == 'variable' || L.style == 'keyword')
                return (L.marked = 'property'), c(Jt, Ct);
            ...
            function Gt(f, p, g) {
              return (
                ...
                (p.lastType == 'quasi' &&
                  /\{\s*$/.test(f.string.slice(0, f.pos - (g || 0))))
              );
            }
            return {
              startState: function (f) {
                ...
                return (
                  we.globalVars &&
                    typeof we.globalVars == 'object' &&
                    (p.globalVars = we.globalVars),
                  p
                );
              },
              token: function (f, p) {
                  ...
                  : et == 'form' && g == '{'
                    ...
                    : et == 'form'
                      ...
                      : et == 'stat'
                        ...
                        : S.info == 'switch' &&
                            !Dt &&
                            we.doubleIndentSwitch != !1
                          ? S.indented +
                            (/^(?:case|default)\b/.test(p) ? He : 2 * He)
                          : S.align
                            ? S.column + (Dt ? 0 : 1)
                            : S.indented + (Dt ? 0 : He);
              },
            ...
            I.defineMIME('application/x-json', {
              name: 'javascript',
              json: !0,
            }),
            I.defineMIME('application/manifest+json', {
              name: 'javascript',
              json: !0,
            }),
            I.defineMIME('application/ld+json', {
              name: 'javascript',
              jsonld: !0,
            }),
            I.defineMIME('text/typescript', {
              name: 'javascript',
              typescript: !0,
            }),
            I.defineMIME('application/typescript', {
              name: 'javascript',
              typescript: !0,
            });
        });
...
(function (mr, Or) {
  (function (I) {
    ...
    function we(ee, G, ue) {
      ...
      return (
        Ee > -1
          ...
          : ce.match(/<\/?$/) &&
            (ee.backUp(ce.length), ee.match(G, !1) || ee.match(ce)),
        ue
      );
    }
    var He = {};
    ...
    function j(ee, G) {
      for (var ue in ee)
        for (
          var ce = G[ue] || (G[ue] = []), Ee = ee[ue], Se = Ee.length - 1;
          Se >= 0;
          Se--
        )
          ce.unshift(Ee[Se]);
      ...
      function (ee, G) {
        ...
        if ((j(Pe, ce), Ee && j(Ee, ce), Se))
          for (var Ae = Se.length - 1; Ae >= 0; Ae--)
            ce.script.unshift(['type', Se[Ae].matches, Se[Ae].mode]);
        function re(J, te) {
          ...
          if (
            ...
            (te.token = function (L, _) {
              ...
              (te.localMode = $),
              (te.localState = I.startState(
                $,
                ue.indent(te.htmlState, '', '')
              ));
          } else
            te.inTag &&
              ((te.inTag += J.current()), J.eol() && (te.inTag += ' '));
          return xe;
        }
        return {
          startState: function () {
          ...
          innerMode: function (J) {
            return {
              state: J.localState || J.htmlState,
              mode: J.localMode || ue,
            };
          },
        };
    ...
    I.defineMode('python', function (j, W) {
        ...
        if ((v && (x.indent = w.indentation()), v && Ce(x).type == 'py')) {
          ...
          if (w.eatSpace()) {
            ...
            return (
              D > y
                ? X(x)
                : D < y && L(w, x) && w.peek() != '#' && (x.errorToken = !0),
              null
            );
          } else {
            var B = Le(w, x);
      ...
      function Le(w, x, v) {
        ...
        for (var Q = 0; Q < ue.length; Q++)
          if (w.match(ue[Q])) return 'operator';
        return w.match(G)
          ? 'punctuation'
      ...
      function Re(w, x) {
        for (; 'rubf'.indexOf(w.charAt(0).toLowerCase()) >= 0; )
          w = w.substr(1);
        var v = w.length == 1,
          y = 'string';
        function D(Q) {
            ...
            return (
              We == 'punctuation' &&
                (ae.current() == '{'
                  ? (Ze.tokenize = D(Q + 1))
                  : ae.current() == '}' &&
                    (Q > 1 ? (Ze.tokenize = D(Q - 1)) : (Ze.tokenize = B))),
              We
            );
          };
        }
        function B(Q, ae) {
          for (; !Q.eol(); )
            if ((Q.eatWhile(/[^'"\{\}\\]/), Q.eat('\\'))) {
              ...
              if (Q.match('{', !1))
                return (
                  (ae.tokenize = D(0)), Q.current() ? y : ae.tokenize(Q, ae)
                );
              if (Q.match('}}')) return y;
      ...
      function X(w) {
        ...
        w.scopes.push({
          offset: Ce(w).offset + j.indentUnit,
          type: 'py',
          align: null,
        });
      }
      ...
      function L(w, x) {
        for (
          var v = w.indentation();
          x.scopes.length > 1 && Ce(x).offset > v;
      ...
      function _(w, x) {
        ...
        var v = x.tokenize(w, x),
          y = w.current();
        if (x.beginningOfLine && y == '@')
          return w.match(J, !1) ? 'meta' : re ? 'operator' : ee;
        if (
        ...
        token: function (w, x) {
          ...
          return (
            y &&
              y != 'comment' &&
              (x.lastToken =
                y == 'keyword' || y == 'punctuation' ? w.current() : y),
...
(function (mr, Or) {
  (function (I) {
    ...
    function He(v) {
      ...
      return (
        (y == ')' || y == ']' || y == '}') && (v.indented = v.context.indented),
    ...
    I.defineMode('clike', function (v, y) {
      ...
      function k(R, ne) {
        ...
        if (q == '"' || q == "'")
          return (ne.tokenize = A(q)), ne.tokenize(R, ne);
        if (yt.test(q)) {
      ...
      function pe(R, ne) {
        y.typeFirstDefinitions &&
          R.eol() &&
          Ce(ne.context) &&
          (ne.typeAtEndOfLine = $e(R, ne, R.pos));
      }
      return {
        ...
        token: function (R, ne) {
          ...
          if (
            ...
            for (q.type == '}' && (q = He(ne)); q.type == 'statement'; )
              q = He(ne);
          } else
            qe == q.type
              ? He(ne)
        ...
        indent: function (R, ne) {
          if ((R.tokenize != k && R.tokenize != null) || R.typeAtEndOfLine)
            return I.Pass;
          var q = R.context,
            be = ne && ne.charAt(0),
            he = be == q.type;
          if (
            (q.type == 'statement' && be == '}' && (q = q.prev),
            y.dontIndentStatements)
          )
            for (
              ;
              q.type == 'statement' && y.dontIndentStatements.test(q.info);
          ...
          return q.type == 'statement'
            ...
            : q.align && (!Q || q.type != ')')
              ...
              : q.type == ')' && !he
                ...
                : q.indented +
                  (he ? 0 : D) +
                  (!he && zt && !/^(?:case|default)\b/.test(ne) ? D : 0);
        },
        electricInput: Ie
          ? /^\s*(?:case .*?:|default:|\{\}?|\})$/
          : /^\s*[{}]$/,
    ...
    function Le(v, y) {
      if ((v.backUp(1), v.match(/^(?:R|u8R|uR|UR|LR)/))) {
        ...
        return D
          ? ((y.cpp11RawStringDelim = D[1]), (y.tokenize = X), X(v, y))
          : !1;
      }
    ...
    function me(v, y) {
      ...
      B(y.keywords),
        ...
        B(y.atoms),
        D.length &&
          ((y.helperType = v[0]), I.registerHelper('hintWords', v[0], D));
      ...
      return function (y, D) {
        for (var B; (B = y.next()); )
          if (B == '*' && y.eat('/'))
            ...
            return (D.tokenize = _(v + 1)), D.tokenize(y, D);
        return 'comment';
      };
    }
    me('text/x-scala', {
    ...
    me('text/x-kotlin', {
      ...
      hooks: {
        ...
        indent: function (v, y, D, B) {
          ...
          if (y.align && y.type == '}')
            return y.indented + (v.context.type == (D || '').charAt(0) ? 0 : B);
        },
      },
      ...
      me('text/x-objectivec++', {
        ...
        defKeywords: M(
          J + ' @interface @implementation @protocol @class class namespace'
        ),
        dontIndentStatements: /^@.*$|^template$/,
        typeFirstDefinitions: !0,
        atoms: M('YES NO NULL Nil nil true false nullptr'),
    ...
    me('text/x-ceylon', {
      ...
      hooks: {
        ...
        '"': function (v, y) {
          return (
            (y.tokenize = x(v.match('""') ? 'triple' : 'single')),
            y.tokenize(v, y)
          );
        },
        '`': function (v, y) {
          return !w || !v.match('`')
            ? !1
            : ((y.tokenize = w), (w = null), y.tokenize(v, y));
        },
        "'": function (v) {
          return v.eatWhile(/[\w\$_\xa1-\uffff]/), 'atom';
        },
        token: function (v, y, D) {
          if ((D == 'variable' || D == 'type') && y.prevToken == '.')
            return 'variable-2';
        },
      },
